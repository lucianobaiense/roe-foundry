...
//     {
//         label: "Conjurador",
//         description: "Concede um bônus de +1 em rolagens de Ressônancia."
//     },
//     {
...
//     {
//         label: "Esperto",
//         description: "Concede um bônus de +1 em rolagens de Defesa Mental e +3 Pontos de Ether (PE)."
//     },
//     {
//         label: "Espinhos",
...
//     {
//         label: "Forte",
//         description: "Concede um bônus de +2 de dano em ataques corpo a corpo."
//     },
//     {
//         label: "Habilidade",
...
//     {
//         label: "Pontaria",
//         description: "Concede um bônus de +1 em rolagens de Ataque à Distância."
//     },
//     {
//         label: "Preciso",
//         description: "Concede um bônus de +1 em rolagens de Ataque Corporal."
//     },
//     {
//         label: "Predador",
...
//     {
//         label: "Rápido",
//         description: "Concede um bônus de +1 em rolagens de Defesa Ágil."
//     },
//     {
//         label: "Regeneração",
...
//     {
//         label: "Fabricável",
//         description: "Esse item pode ser fabricado usando a carreira Artesão."
//     },
//     {
//         label: "Pesada 1",
...
//     {
//         label: "Alquímico",
//         description: "Esse item pode ser fabricado usando a carreira Alquimia."
//     },
//     {
//         label: "Barulhenta",
...
//     {
//         label: "Refeição",
//         description: "Esse item é do tipo Refeição e pode ser afetado por habilidades que utilizem esse traço."
//     }
// ]
...
//     {
//         label: "Alcance (Curto)",
//         description: "Esse item pode ser arressado em até Alcance (Curto). Quando você ataca um alvo em Alcance Fechado, enquanto está montado ou conduzindo um veículo e estiver usando uma arma com o traço Alcance você sofre Desvantagem na rolagem."
//     },
//     {
//         label: "Alcance (Médio)",
//         description: "Esse item pode ser arressado em até Alcance (Médio). Quando você ataca um alvo em Alcance Fechado, enquanto está montado ou conduzindo um veículo e estiver usando uma arma com o traço Alcance você sofre Desvantagem na rolagem."
...
//     {
//         label: "Explosiva",
//         description: "Armas explosivas causam dano a todas as criaturas dentro de uma Zona. Uma arma explosiva lista o dano que causa entre parênteses, ou seja, uma arma com Explosiva (2) causa seu dano base no alvo principal e mais 2 de dano a cada criatura dentro da Zona do alvo original."
//     },
//     {
//         label: "Impactante",
...
traits.armor = [
    {
        label: "Barulhenta",
        description: "Você recebe Desvantagem em rolagens usando a perícia Furtividade."
    },
    {
        label: "Discreta",
        description: "Armaduras com esse traço podem ser escondidas usando roupas comuns sobre ela. Alguém que desconfie de você por algum motivo pode fazer uma disputa (Investigação x Furtividade) para perceber que você está usando uma armadura."
    },
    {
        label: "Pesada [ 1 ]",
        description: "Para vestir esta armadura corretamente, seu valor de Corpo deve ser igual ou superior ao número indicado entre colchetes. Se seu Corpo for menor que esse número, você sofrerá a condição Lento enquanto vestir ela."
    },
    {
        label: "Pesada [ 2 ]",
        description: "Para vestir esta armadura corretamente, seu valor de Corpo deve ser igual ou superior ao número indicado entre colchetes. Se seu Corpo for menor que esse número, você sofrerá a condição Lento enquanto vestir ela."
    ...
    {
        label: "Restritiva",
        description: "Armaduras com esse traço são pesadas e restringem os movimentos dos usuários. Você recebe as seguintes penalidades: Desvantagem em rolagens usando as perícias Atletismo ou Furtividade. Uma penalidade de -1 em rolagens usando a defesa Reflexos."
    }  
]
...
traits.consumable = [
    {
        label: "Alquímico",
        description: "São itens que podem ser fabricados com Alquimia e possuem uma DIF própria para criação já informada na descrição dos próprios itens. Certas habilidades se beneficiam desse traço."
    },
    {
        label: "Natural",
        description: "São itens que não podem ser fabricados, somente colhidos através de Natureza. Certas habilidades se beneficiam desse traço."
    },
    {
        label: "Refeição",
        description: "São itens que podem ser fabricados com Ofícios e possuem uma DIF própria para criação já informada na descrição dos próprios itens. Certas habilidades se beneficiam desse traço."
    },
    {
        label: "Fabricável",
        description: "São itens que podem ser fabricados com Ofícios e possuem uma DIF própria para criação. Certas habilidades se beneficiam desse traço. Somente um efeito concedido por consumíveis com esse traço pode estar ativo por vez, os efeitos duram 24 horas."
    }  
]

traits.sortilege = [
    {
        label: "Alcance [ Fechado ]",
        description: "Esta arma pode atacar à distância, esse alcance é determinado pela palavra indicada entre colchetes."
    },
    {
        label: "Alcance [ Curto ]",
        description: "Esta arma pode atacar à distância, esse alcance é determinado pela palavra indicada entre colchetes."
    ...
    {
        label: "Alvos [ X ]",
        description: "Esta arma pode acertar uma quantidade de alvos por ataque igual ao número indicado entre colchetes, os alvos não podem ser repetidos. Use a mesma rolagem para todos os alvos."
    },
    {
        label: "Densidade [ X ]",
        description: "Devolve como dano (que não pode ser reduzido) seu valor de Densidade, reduza também a Durabilidade da arma que o atingiu (se corpo a corpo) no mesmo valor."
    },
    {
        label: "Estilhaçar",
        description: "Esta arma reduz a Durabilidade (DU) da armadura do alvo em um valor igual ao Ranque da mesma."
    },
    {
        label: "Penetrante",
        description: "Esta arma perfura armaduras, reduza da RF da mesma um valor igual ao Ranque dessa arma."
    },
    {
        label: "Ultrapassar [ X ]",
        description: "Adicione a todo o dano causado seu valor de Ultrapassar, esse dano não pode ser prevenido ou reduzido."
    },
    {
        label: "Zona",
        description: "Essa arma atinge todos os alvos na Zona alvejada."
    }      
]
...
traits.weapon = [
    {
        label: "Afastar",
        description: "Impede que o alvo entre em Alcance Fechado com você."
    },
    {
        label: "Alcance [ Curto ]",
        description: "Esta arma pode atacar à distância, esse alcance é determinado pela palavra indicada entre colchetes. Podendo ser Curto, Médio, Longo, Muito Longo. Ver Alcances na página X."
    },
    {
        label: "Alcance [ Médio ]",
        description: "Esta arma pode atacar à distância, esse alcance é determinado pela palavra indicada entre colchetes. Podendo ser Curto, Médio, Longo, Muito Longo. Ver Alcances na página X."
    ...
    {
        label: "Aprisionar",
        description: "Em um ataque bem-sucedido, você pode aprisionar o alvo. Enquanto estiver preso, ele fica Imóvel, mas você deve permanecer na mesma Zona que ele. No início de cada turno, o alvo pode tentar se libertar com uma Disputa (Precisão x Reflexos). Se falhar, continua aprisionado."
    },
        {
        label: "Atravessar",
        description: "Permite atingir 1 alvo em uma Zona adjacente."
    },
    {
        label: "Arco",
        description: "Esta arma pode atacar todas as criaturas que estiverem Engajadas com você."
    },
    {
        label: "Arremessável",
        description: "Permite arremessar sua arma em até Alcance (Médio). "
    },
    {
        label: "Barulhenta",
        description: "Quando usa sua arma todos na cena podem fazer um Teste (Percepção 12) para descobrir sua localização."
    },
        {
        label: "Carga",
        description: "Quando usa Atacar (Carga) não recebe a penalidade associada a essa ação."
    },
    {
        label: "Defensiva",
        description: "Você pode adotar uma postura defensiva (▷) com sua arma, some o Ranque da mesma em sua próxima disputa de defesa, além disso você pode usar Vigor no lugar de Reflexos na rolagem."
    },
    {
        label: "Desarmar",
        description: "Permite realizar uma manobra para desarmar o oponente."
    },
    {
        label: "Duas Mãos",
        description: "Esta arma precisa de duas mãos para fazer um ataque."
    },
    {
        label: "Empunhadura",
        description: "Esta arma pode ser empunhada com as duas mãos, se o fizer aumente o dano causado em +1."
    },
        {
        label: "Empurrar",
        description: "Você pode se Desengajar do alvo atacado sem consumir ações."
    },
    {
        label: "Estilhaçar",
        description: "Esta arma reduz a Durabilidade (DU) da armadura do alvo em um valor igual ao Ranque da mesma."
    ...
    {
        label: "Explosiva",
        description: "Esta arma causa dano adicional (do mesmo tipo da arma) igual a 2 vezes o Ranque da mesma na Zona onde explodir, esse dano não pode ser evitado (mas ainda pode ser reduzido por RF)."
    },
    {
        label: "Impactante",
        description: "Em um ataque (✦) causa a condição Desbalanceado."
    },
    {
        label: "Lacerante",
        description: "Em um ataque (✦) causa a condição Sangrando."
    },
    {
        label: "Lentidão",
        description: "Esta arma reduz a mobilidade do alvo alterando a velocidade do mesmo para Lenta por 1 turno."
    },
    {
        label: "Longa",
        description: "Esta arma é alongada e permite realizar ataques corpo a corpo contra qualquer alvo em sua Zona sem estar Engajado."
    },
    {
        label: "Mortal",
        description: "Esta arma é otimizada para matar, aumente em +1d6 o dano causado."
    },
    {
        label: "Munição",
        description: "Esta arma precisa de munição para ser usada. O tipo de dano causado é determinado pela munição usada, veja os consumíveis Munição e Munição Explosiva na página X."
    },
    {
        label: "Par",
        description: "Quando esta arma é usada como arma secundária ela aumenta o dano causado por sua arma primária em um valor igual ao Ranque dessa arma."
    },
    {
        label: "Penetrante",
        description: "Esta arma perfura armaduras, reduza da RF da mesma um valor igual ao Ranque dessa arma."
    ...
    {
        label: "Pesada [ 1 ]",
        description: "Para empunhar esta arma corretamente, seu valor de Corpo deve ser igual ou superior ao número indicado entre colchetes. Se seu Corpo for menor que esse número, você sofre Desvantagem em todos os ataques usando essa arma."
    },
    {
        label: "Pesada [ 2 ]",
        description: "Para empunhar esta arma corretamente, seu valor de Corpo deve ser igual ou superior ao número indicado entre colchetes. Se seu Corpo for menor que esse número, você sofre Desvantagem em todos os ataques usando essa arma."
    ...
    {
        label: "Precisa",
        description: "Esta arma é balanceada para ataques, você recebe Vantagem na rolagem de Atacar."
    },
    {
        label: "Rápida",
        description: "Esta arma é veloz, altere sua velocidade para Rápida por 1 turno."
    },
    {
        label: "Recarga [ Rápida ]",
        description: "Esta arma precisa recarregar entre ataques, você usa 1 ação padrão (►) para recarregar."
    },
    {
        label: "Recarga [ Lenta ]",
        description: "Esta arma precisa recarregar entre ataques, você usa 2 ações padrão ( ►► ) para recarregar."
    },
    {
        label: "Versátil",
        description: "Essa arma pode ser usada de várias formas. Você recebe +1 de bônus quando usa a ação Manobra."
    },
    {
        label: "Zona",
        description: "Essa arma atinge todos os alvos na Zona alvejada."
